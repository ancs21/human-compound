...
// Security review
Task({
  subagent_type: "human-compound:review:security-sentinel",
...
// Performance review
Task({
  subagent_type: "human-compound:review:performance-oracle",
...
// Architecture review
Task({
  subagent_type: "human-compound:review:architecture-strategist",
...
// Code simplicity
Task({
  subagent_type: "human-compound:review:code-simplicity-reviewer",
  description: "Simplicity check",
  prompt: "Check if this implementation can be simplified"
})
```

**All review agents from human-compound:**
...
Task({
  subagent_type: "human-compound:research:best-practices-researcher",
...
Task({
  subagent_type: "human-compound:research:framework-docs-researcher",
...
Task({
  subagent_type: "human-compound:research:git-history-analyzer",
...
```javascript
Task({
  subagent_type: "human-compound:workflow:bug-reproduction-validator",
