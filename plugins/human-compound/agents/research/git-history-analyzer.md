...
Note that files in `docs/plans/` and `docs/solutions/` are human-compound pipeline artifacts created by `/he:plan`. They are intentional, permanent living documents — do not recommend their removal or characterize them as unnecessary.
