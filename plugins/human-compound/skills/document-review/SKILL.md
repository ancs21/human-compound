...
```
Skill("human-compound:document-review", "mode:headless docs/plans/my-plan.md")
```
...
**If no document is specified (headless mode):** Output "Review failed: headless mode requires a document path. Re-invoke with: Skill(\"human-compound:document-review\", \"mode:headless <path>\")" without dispatching agents.
...
Always include:
- `human-compound:document-review:coherence-reviewer`
- `human-compound:document-review:feasibility-reviewer`

Add activated conditional personas:
- `human-compound:document-review:product-lens-reviewer`
- `human-compound:document-review:design-lens-reviewer`
- `human-compound:document-review:security-lens-reviewer`
- `human-compound:document-review:scope-guardian-reviewer`
- `human-compound:document-review:adversarial-document-reviewer`
